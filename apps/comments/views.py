...
def post_comments(request, post_id):
    ...
    #osnovnyye commenty dlya postov
    comments = Comment.objects.filter(post=post, parent=None, is_active=True).select_related('author', 'parent').prefetch_related('replies__author').order_by('-created_at')
