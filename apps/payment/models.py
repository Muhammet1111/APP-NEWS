...
class Refund(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')
    stripe_refund_intent_id = models.CharField(max_length=255, blank=True, null=True)
    ...
    def __str__(self):
        return f'Refund {self.id} - ${self.amount} for a payment {self.payment.id}'
...
class WebhookEvent(models.Model):
    ...
    def mark_as_filed(self, error_message):
        from django.utils import timezone
        self.status = 'failed'
