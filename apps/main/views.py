...
from .serializers import CategorySerializer, PostListSerializer, PostDetailSerializer, PostCreateUpdateSerializer
...
class PostListCreateView(generics.ListCreateAPIView):
    '''api endpoint dlya postov s podderzhkoy zakrepleniya, zakrep posty otobrazhayutsya pervymi'''
    ...
    def get_queryset(self):
        'vozvrat postos s dostupom'
        queryset = Post.objects.select_related('author', 'category')
        
        'filtratsiya po pravu dostupa'
...
class PostDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        'uvelichenie kolichestva prosmotrov pri poluchenii detaley posta'
